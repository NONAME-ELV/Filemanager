...
* **Penting**: Pastikan variabel `$secret` di dalam `cyberpunk.php` sudah terkonfigurasi dengan benar untuk mencegah akses dari pihak yang tidak berwenang parameternya sebagai contoh : *cyberpunk.php?id=@elv*.
